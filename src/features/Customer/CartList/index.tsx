...
function CardList({ setShowCart, showCart }: any) {
  ...
  return (
    <section
      className={clsx(
        "fixed top-0 bottom-0  right-0 left-[60%] z-50 bg-[#fff] drop-shadow-2xl translate-x-full overflow-auto",
    ...
    >
      ...
      <Button type="primary" className="mx-10 my-20" size="large"> Buy Now</Button>
